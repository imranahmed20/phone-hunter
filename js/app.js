...
const displayPhoneDetails = phone => {
    ...
    <p>DisplaySize: ${phone.mainFeatures ? phone.mainFeatures.displaySize: 'No displaySize information'}</p>
    <p>Sensors: ${phone.mainFeatures.sensors ? phone.mainFeatures.sensors[0]: 'No Bluetooth information'}</p>
